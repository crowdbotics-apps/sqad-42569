"""
Django settings for sqad_42569 project.
...
WSGI_APPLICATION = 'sqad_42569.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sqad_42569 API",
    "DESCRIPTION": "API documentation for sqad_42569 App",
    "VERSION": "v1",
}
